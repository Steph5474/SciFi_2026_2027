...
there are two libraries for VADER sentiment analysis:
1. vaderSentiment --> older, standalone package
2. nltk.sentiment.vader --> newer, maintained, faster, recommended
"""
